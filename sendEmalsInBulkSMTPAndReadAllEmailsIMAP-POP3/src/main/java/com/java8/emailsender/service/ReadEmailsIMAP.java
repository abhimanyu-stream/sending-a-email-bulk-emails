...
public class ReadEmailsIMAP {
	...
	public void readEmailsUsingIMAP() throws MessagingException, IOException {

		//NOTE:- EMAILS ARE BEING READ FROM THAT EMAIL ACCOUNT WHICH IS CONFIGURED IN IMAP
